...
export default function Home({ currentPage, handlePageChange }) {
  ...
  return (
    <div className="flex justify-center items-center w-screen m-0 p-0"
      ...
      <img
        ...
        alt="casino"
      />
      <div className="flex justify-center items-center glass bg-primary rounded-box text-primary-content z-20"
