        ...
        <div className="navbar z-20 bg-neutral text-primary-content w-screen">
          ...
          <div className="flex-none">
            <ul className="menu menu-horizontal p-0">
              <li tabIndex="0">
                ...
                <ul className="p-2 bg-neutral text-primary-content">
                  <li className="text-lg text-color-primary px-2 mx-2">
                    <a href="#landingpage" onClick={() => handlePageChange("Home")} className={currentPage === "Home" ? "nav-link active" : "nav-link"}>Home</a>
                  </li>
              ...
              <li tabIndex="0">
                <a href="/" onClick={() => handlePageChange("Home")} className={currentPage === "Home" ? "nav-link active" : "nav-link"}>Logout</a>
              </li>
            </ul>
          </div>
        </div>
